...
public:
    ...
    /// Set the syncWord for communication over the network
    /// Caution: this should be set to the same 
    /// value on all nodes in your network. Default is 0x12
    /// Sets the message syncWord in RH_RF95_REG_39_SYNC_WORD
    /// \param[in] byte syncWord
